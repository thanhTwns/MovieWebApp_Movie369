    ...
    <ul class="navbar">
        ...
        <li class="dropdown-item">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="#">Tình cảm</a></li> <li><a href="#">Viễn tưởng</a></li>
        ...
        <li class="search-item">
            <form action="search" method="GET" class="search-box">
                <input type="text" name="query" class="search-input" placeholder="Tìm kiếm phim...">
        ...
        <c:if test="${sessionScope.account != null}">
            <li class="user-profile dropdown-item">
                <div class="profile-toggle">
                    <img src="nhetanhdoday/default-avatar.jpg" alt="User" class="user-img">
